      ...
      <table class="table table-hover  table-bordered align-middle">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo e(ucfirst($paciente->sexo)); ?></td>
            <td><?php echo e($paciente->fecha_nacimiento); ?></td>
            <td><?php echo e($paciente->tipo_ecografia); ?></td>
            <td>$<?php echo e(number_format($paciente->precio, 2)); ?></td>
            <td>
              <button
                class="btn btn-warning btn-sm me-1 text-white btn-editar"
                data-id="<?php echo e($paciente->id); ?>"
                data-nombres="<?php echo e($paciente->nombres); ?>"
                data-apellidos="<?php echo e($paciente->apellidos); ?>"
                data-cedula="<?php echo e($paciente->cedula); ?>"
                data-telefono="<?php echo e($paciente->telefono); ?>"
                data-email="<?php echo e($paciente->email); ?>"
                data-sexo="<?php echo e($paciente->sexo); ?>"
                data-fecha_nacimiento="<?php echo e($paciente->fecha_nacimiento); ?>"
                data-tipo_ecografia="<?php echo e($paciente->tipo_ecografia); ?>"
                data-precio="<?php echo e($paciente->precio); ?>"
              ...
              <form action="<?php echo e(route('pacientes.destroy', $paciente->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('¿Seguro que quieres eliminar este paciente?');">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Usuario\EcoProyecto\resources\views/logica/pacientes.blade.php ENDPATH**/ ?>